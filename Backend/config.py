...
VIDEO_OCR_LANGS = os.getenv("VIDEO_OCR_LANGS", "en").split(",")
VIDEO_OCR_USE_GPU = os.getenv("VIDEO_OCR_USE_GPU", "0") == "1"
VIDEO_OCR_MIN_CONFIDENCE = float(os.getenv("VIDEO_OCR_MIN_CONFIDENCE", "0.5"))
