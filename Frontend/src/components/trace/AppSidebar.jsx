...
import { UploadZone } from "@/components/trace/UploadZone";
import { cn } from "@/lib/utils";
import { getAuth, logoutAndGoHome } from "@/lib/trace-auth";
...
export function AppSidebar({ files, onFilesChange, onUpload, className }) {
  const auth = getAuth();
  return (
    <aside className={cn(
      ...
      <div className="p-4 border-b border-sidebar-border">
        ...
        <UploadZone files={files} onFilesChange={onFilesChange} onUpload={onUpload} />
      </div>
